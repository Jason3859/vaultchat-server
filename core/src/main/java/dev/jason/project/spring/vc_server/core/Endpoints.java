...
public class Endpoints {
	...
	public static final String MARK_LOGOUT = "/mark-logout";
	public static final String LOGOUT_ACKNOWLEDGEMENT = "/logout-acknowledgement";
	public static final String LOGOUT_QUEUE = "/logout-queue";
